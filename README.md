...
7. A new window will open where you can fetch actual weather data and show temperature predicitions with the result in a graph.

8. If you want to train the model again you can run `train_model.py`, that is located in the `/utils` folder.
